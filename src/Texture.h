...
public:
	...
	Texture(const GLchar* path, const TextureFileFormat& fileFormat, const TextureFormat& format, bool flip = false);
	Texture(const GLchar* path, const TextureFileFormat& fileFormat, const TextureFormat& format, const TextureWrapMode& sWrapMode, const TextureWrapMode& tWrapMode, const TextureFilterMode& minFilterMode, const TextureFilterMode& magFilterMode, bool flip = false);
	virtual ~Texture();
